...
const news = [
  {
    ...
    'zh-TW': {
      title: 'SFC秋季慶典',
      content: `即去年的三田祭之後，台灣屋台將再度回歸！
這次我們會在慶應的湘南藤澤校區（SFC) 的秋祭販賣蔥抓餅以及珍珠奶茶！
來這裡可以吃到令人懷念的台灣蔥抓餅，還有QQ的珍珠奶茶喔〜
也可以觀望美麗的花火還有熱情四射的各種表演！歡迎大家透過這次的機會乘坐一個小時的電車來關心一下遠在天邊近不在眼前、綠意盎然的神奇校區。
一定要記得來慶應秋祭喔！
時間：10月13日11時〜19時
...
秋祭是什麼？`,
    ...
    en: {
      ...
      content: `Taiwanese food stall is coming back!!
This time, the Keio Taiwanese Student Association(KTSA) will open a stall selling Taiwanese snack food at Akisai!!
We will offer crispy scallion pancakes and bubble tea with chewy tapioca balls.
Please do not miss the chance to have a taste of Taiwanese snack food!!
There will also be a fireworks show at the end of the festival 🎆
...
`,
    ...
    ja: {
      title: 'SFC秋祭',
      content: `去年の三田祭で大好評だった台湾屋台が帰ってきた！
この度、慶應台湾人留学生会は本場の台湾点心を販売いたします！
今回は、香ばしくて焼き上げた蔥抓餅（ツォンジュアビン）とモチモチ食感のタピオカミルクティーをご用意しております！
みなさまもこの機会を見逃しなく、台湾ローカルの味を味わってみたらいかがでしょうか！
時間：10月13日11時〜19時
...
秋祭について`,
  ...
  },
  {
    ...
    'zh-TW': {
      title: '早慶交流活動',
      content: `【慶應&早稻田交流活動】
活動時間：6/22(土) 12:30-17:30 (晚餐聚餐18：00~20：00)
活動地點：早稻田大學本校區
...
別科、研究生、已畢業學長姐也歡迎參加！`,
    ...
    en: {
      ...
      content: `[KTSA/WTSA exchange activity]
Time: 6/22(Sat) 12:30-17:30 (after party: 18:00-20:00)
...
Graduate students,OBOGs, and language school students are also welcomed`,
    ...
    ja: {
      title: '慶早交流イベント',
      content: `【慶早交流イベント】
時間：6/22(土) 12:30-17:30 (アフターパーティー18：00~20：00)
場所：早稲田大学本キャンパス
...
1. Activities PR Personnel(2people)
2. Media PR Promotion(2people)
3. innovative design (several)
4. web developer (1person)

🔸Qualification
Students who hold a Taiwanese passport and are currently enrolled in schools in Japan.
...
有興趣的同學務必不要錯過！`,
    ...
    en: {
      title: 'Tokyo National Museum - International student discount day',
